...
function sGetChineseName($rsCustomFields, $per_ID){
  ...
  while ( $rowCustomField = mysql_fetch_array($rsCustomFields) ){
      extract($rowCustomField);
      $currentFieldData = trim($aCustomData[$custom_Field]);
      if($custom_Name == "Chinese Name 姓名"){
...
*/
		...
		while ($aRow = mysql_fetch_array($rsPersons)) {
			...
			$per_cnName = sGetChineseName($rsCustomFields, $per_ID);
